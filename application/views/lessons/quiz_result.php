    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body" style="text-align: center;">
                <h5 class="card-title" style="font-weight: : bold;"><?php echo get_phrase('Your_course_is_sucessfully_completed'); ?>.</h5>
                <h5 class="card-title" style="font-weight: : bold;">You scored : <?php echo (int)$quiz_percentage; ?>%</h5>
                <h6 class="card-text"><?php echo get_phrase('please_download_certificate'); ?>&nbsp;<a href="<?php echo base_url(); ?>home/download_pdf/<?php echo $cour_id; ?>" class="btn btn-primary">Download Certificate</a></h6>
            </div>
        </div>
    </div>
</div>
