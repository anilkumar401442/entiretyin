f<?php if(get_frontend_settings('recaptcha_status')): ?>
                      ...
                      <form action="<?php echo site_url('login/register'); ?>" method="post" id="sign_up">
                          <div class="content-box">
                              <div class="basic-group">
                                  ...
                                  <div class="form-group">
                                      <label for="last_name"><span class="input-field-icon"><i class="fas fa-mobile"></i></span> <?php echo site_phrase('mobile'); ?>:</label>
                                      <input type="text" class="form-control" name = "mobile" id="mobile" placeholder="<?php echo site_phrase('mobile'); ?>" value="" required>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <label for="registration-country"><span class="input-field-icon"><i class="fas fa-lock"></i></span> <?php echo site_phrase('country'); ?>:</label>
