    ...
    <div class="row">
      <div class="col-md-6">
        <p class="copyright-text">
          ...
          <a href="https://www.entiretyin.com" target="_blank"><?php echo get_settings('footer_text'); ?></a>
        </p>
      </div>
      <div class="col-md-6">
        <ul class="nav justify-content-md-end footer-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('home/refund_and_cancel'); ?>"><?php echo site_phrase('refund_and_cancellation_policy'); ?></a>
          </li>
		  <li class="nav-item">
            <a class="nav-link" href="home/contact_us"><?php echo site_phrase('contact_us'); ?></a>
          </li>
          <li class="nav-item">
