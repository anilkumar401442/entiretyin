...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<li class="side-nav-item">
			<a href="<?php echo site_url('admin/registration_tracking'); ?>" class="side-nav-link <?php if ($page_name == 'registration_tracking')echo 'active';?>">
				<i class="dripicons-user-group"></i>
				<span><?php echo get_phrase('Registration Track'); ?></span>
			</a>
		</li>
		<li class="side-nav-item">
			<a href="<?php echo site_url('admin/pending_payments'); ?>" class="side-nav-link <?php if ($page_name == 'pending_payments')echo 'active';?>">
				<i class="dripicons-user-group"></i>
				<span><?php echo get_phrase('Pending Payments'); ?></span>
			</a>
		</li>
		<li class="side-nav-item">
			<a href="<?php echo site_url('admin/promocode'); ?>" class="side-nav-link <?php if ($page_name == 'promocode')echo 'active';?>">
				<i class="dripicons-list"></i>
				<span><?php echo get_phrase('Promo Code'); ?></span>
			</a>
		</li>
