  ...
  <div class="col-12">
    <div class="page-title-box ">
      ...
      <div class="row">
          ...
          <div class="col-md-6">
              <a href="<?php echo site_url('admin/categories'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm my-1"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_categories_list'); ?></a>
          </div>
      </div>
    </div>
  </div>
