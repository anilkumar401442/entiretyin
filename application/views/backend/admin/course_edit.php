                        ...
                        <form class="required-form" action="<?php echo site_url('admin/course_actions/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="form-group row mb-3">
												...
												<div class="col-md-10">
														...
														<?php $user_list = $this->user_model->get_instructor()->result_array();
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-8">
                                        ...
                                        <div class="paid-course-stuffs">
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="discounted_price"><?php echo get_phrase('batch_one'); ?></label>
                                                <div class="col-md-10">
                                                    <input type="date" class="form-control" name="batch1" id="batch1" value="<?php echo $course_details['batch1']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="discounted_price"><?php echo get_phrase('batch_two'); ?></label>
                                                <div class="col-md-10">
                                                    <input type="date" class="form-control" name="batch2" id="batch2" value="<?php echo $course_details['batch2']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="discounted_price"><?php echo get_phrase('batch_three'); ?></label>
                                                <div class="col-md-10">
                                                    <input type="date" class="form-control" name="batch3" id="batch3" value="<?php echo $course_details['batch3']; ?>" >
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                            ...
                            <div class="tab-pane" id="media">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-xl-8">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-2 col-form-label" for="course_overview_url"><?php echo get_phrase('course_companies_images'); ?></label>
                                            <div class="col-md-10">
                                                <input type="file" class="form-control" name="userfile[]" id="course_companies_image" multiple="multiple">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="col-md-3">
                                                <div class="card">
												  ...
												  <a href="javascript::" onclick="confirm_modal('<?php echo site_url('admin/delete_course_company_image/'.$course_details['id'].'/one'); ?>');"><i class="fas fa-trash"></i></a>
												  </div>
												  <div class="card-body">
												  <?php if($course_details['course_companies_image_one'] == ''){ ?>
												        No Image Uploaded
												  <?php }else{ ?>
													  <img class="card-img-top" src="<?php echo base_url(); ?>assets/uploads/course/<?php echo $course_details['course_companies_image_one']; ?>" alt="image" width="15px"> 
												  <?php } ?>
												  </div>
												</div>
											</div>
                                            <div class="col-md-3">											
												<div class="card">
												  <div class="card-header" style="text-align:center">
												  <a href="javascript::" onclick="confirm_modal('<?php echo site_url('admin/delete_course_company_image/'.$course_details['id'].'/two'); ?>');"><i class="fas fa-trash"></i></a>
												  </div>
												  <div class="card-body">
												  <?php if($course_details['course_companies_image_two'] == ''){ ?>
												        No Image Uploaded
												  <?php }else{ ?>
													  <img class="card-img-top" src="<?php echo base_url(); ?>assets/uploads/course/<?php echo $course_details['course_companies_image_two']; ?>" alt="image" width="15px"> 
												  <?php } ?>
												  </div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="card">
												  <div class="card-header" style="text-align:center">
												  <a href="javascript::" onclick="confirm_modal('<?php echo site_url('admin/delete_course_company_image/'.$course_details['id'].'/three'); ?>');"><i class="fas fa-trash"></i></a>
												  </div>
												  <div class="card-body">
												  <?php if($course_details['course_companies_image_three'] == ''){ ?>
												        No Image Uploaded
												  <?php }else{ ?>
													  <img class="card-img-top" src="<?php echo base_url(); ?>assets/uploads/course/<?php echo $course_details['course_companies_image_three']; ?>" alt="image" width="15px"> 
												  <?php } ?>
												  </div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="card">
												  <div class="card-header" style="text-align:center">
												  <a href="javascript::" onclick="confirm_modal('<?php echo site_url('admin/delete_course_company_image/'.$course_details['id'].'/four'); ?>');"><i class="fas fa-trash"></i></a>
												  </div>
												  <div class="card-body">
												  <?php if($course_details['course_companies_image_four'] == ''){ ?>
												        No Image Uploaded
												  <?php }else{ ?>
													  <img class="card-img-top" src="<?php echo base_url(); ?>assets/uploads/course/<?php echo $course_details['course_companies_image_four']; ?>" alt="image" width="15px"> 
												  <?php } ?>
												  </div>
												</div>
											</div>
                                    ...
                                    <div class="col-xl-8">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-2 col-form-label" for="course_overview_url"><?php echo get_phrase('why_learn_course'); ?></label>
                                            <div class="col-md-10">
                                                <textarea rows="6" class="form-control" name="why_learn_course" id="why_learn_course"><?php echo $course_details['why_learn_course'] ?></textarea>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
