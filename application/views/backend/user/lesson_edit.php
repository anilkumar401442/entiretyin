...
<div class="alert alert-info" role="alert">
    ...
    <strong>
        ...
        elseif($lesson_details['lesson_type'] == 'textcontent' ){
            echo get_phrase('text_content');
        }
        ?>.
    </strong>
</div>
...
<form action="<?php echo site_url('user/lessons/'.$param3.'/edit'.'/'.$param2); ?>" method="post" enctype="multipart/form-data">
    ...
    <?php if ($lesson_details['lesson_type'] == 'textcontent'): include('text_type_lesson_edit.php'); endif; ?>
